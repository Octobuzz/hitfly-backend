...
import PlayNextIcon from '~/components/shared/icons/popover/PlayNextIcon.vue';
import ListPlusIcon from '~/components/shared/icons/popover/ListPlusIcon.vue';
import PlusIcon from '~/components/shared/icons/popover/PlusIcon.vue';
import HeartIcon from '~/components/shared/icons/popover/HeartIcon.vue';
import UserPlusIcon from '~/components/shared/icons/popover/UserPlusIcon.vue';
import CrossIcon from '~/components/shared/icons/popover/CrossIcon.vue';
import BendedArrowIcon from '~/components/shared/icons/popover/BendedArrowIcon.vue';
import gql from './gql';
