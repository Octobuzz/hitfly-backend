...
<script>
import AddToFavouriteButton from '~/components/shared/AddToFavouriteButton/AddToFavouriteButton.vue';
import IconButton from '~/components/shared/IconButton.vue';
import DotsIcon from '~/components/shared/icons/DotsIcon.vue';
