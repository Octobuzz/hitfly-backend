    ...
    <div class="asideBlock__body">
      ...
      <template v-else>
        <div
          ...
          :columnLayout="true"
        >
          <div class="track-list-with-comments"
            ...
            <div class="comment">
              <div class="comment__header">
                <div class="sidebarStarComment">
                  ...
                  <router-link :to="`/user/${track.comments[0].user.id}/user-reviews`" class="sidebarStarComment__name">{{ track.comments[0].user.username }}</router-link>
                </div>
                <p class="sidebarStarDate">{{ parsedDate(index) }}</p>
              </div>
              <div class="comment__body" :class="{ hidden: hidden }" @click="hidden = !hidden">
