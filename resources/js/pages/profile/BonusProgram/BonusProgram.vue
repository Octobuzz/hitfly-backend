...
<!--            </button>-->
    ...
    <div :class="['bonus-program__bottom-section', containerPaddingClass]">
      ...
      <ul class="bonus-program__bottom-section-ul">
        ...
        <li class="bonus-program__li">
          Звездный эксперт / Профессиональный критик — Звездный эксперт, который загружал треки, может
          ...
          ни одного отзыва, и может понизить до Слушателя, если Звездный эксперт не загружал треки.
        </li>
      </ul>
