...
<!--            </button>-->
    ...
    <div :class="['bonus-program__bottom-section', containerPaddingClass]">
      ...
      <ul class="bonus-program__bottom-section-ul">
        ...
        <li class="bonus-program__li">
          Критик — Критик, который загружал треки, может понизить уровень до Музыканта,
          ...
          понизить до Слушателя, если Критик не загружал треки.
        </li>
        <li class="bonus-program__li">
          Звезда / Профессиональный критик — Звезда, которая загружала треки, может
          понизить уровень до Музыканта, если более 30% отзывов не оцениваются другими
          пользователями как полезные, или если в течение 2 месяцев Звезда не оставила
          ни одного отзыва, и может понизить до Слушателя, если Звезда не загружала треки.
        </li>
      </ul>
