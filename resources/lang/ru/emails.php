...
return [
    ...
    'socialPassword' => [
        'hello' => 'Здравствуйте',
        'text' => 'Вы зарегистрировались через одну из социальных сетей, для Вашего удобства мы сгенерировали пароль для входа с помощью Вашего email адреса.
        <br>Вы можете использовать email: :email<br> и пароль: :pass для входа на сайт.',
        'subject' => 'Ваш пароль для входа через email',
    ],
    'verifyEmail' => [
