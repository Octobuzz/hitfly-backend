                        ...
                        <table width="504" cellpadding="0" cellspacing="0" border="0" align="center" style="padding: 35px 0;">
                            ...
                            <tr>
                                <td style="padding-bottom: 20px;">
                                    <h3 style="font-size: 24px; font-weight: 700; color: #2f2f2f; margin: 0 0 15px;">@lang('emails.fewCommentsMonth.hello'), {{$user->username}}!</h3>
                                    <p style="font-size: 16px; line-height: 24px; color: #313131; margin: 0 0 20px;">
                                        @lang('emails.fewCommentsMonth.text')
                                    </p>
                                    <p style="font-size: 16px; line-height: 24px; color: #313131; margin: 0;">
                                        @lang('emails.fewCommentsMonth.text2')
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="{{ config('app.url') }}/profile/reviews" style="display: block; width: 208px; height: 40px; font-size: 14px; line-height: 40px; text-decoration: none; text-align: center; color: #fff; background-image: url('{{ config('app.url') }}/images/emails/icons/gradient-link.png'); margin: 0 0 40px;">@lang('emails.fewCommentsMonth.createFeedback')</a>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom: 15px">
                                    <h3 style="font-size: 24px; font-weight: 700; color: #2f2f2f; margin: 0 0 10px;">@lang('emails.fewCommentsMonth.newTracks')</h3>
                                </td>
                            </tr>
                            <tr>
                                <td>
