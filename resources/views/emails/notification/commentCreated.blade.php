                ...
                <tr>
                    <td>
                        <table width="504" cellpadding="0" cellspacing="0" border="0" align="center" style="padding: 0 0 35px;">
                            ...
                            <tr>
                                <td>
                                    <a href="{{$allCommentsUrl}}" style="display: block; width: 255px; height: 40px; font-size: 14px; line-height: 40px; text-decoration: none; text-align: center; color: #fff; background-image: url('images/icons/gradient-link-big.png');">
