                ...
                <tr>
                    <td>
                        <table width="504" cellpadding="0" cellspacing="0" border="0" align="center" style="padding: 35px 0;">
                            ...
                            <tr>
                                <td>
                                    <a href="#" style="display: block; width: 208px; height: 40px; font-size: 14px; line-height: 40px; text-decoration: none; text-align: center; color: #fff; background-image: url('{{ env('APP_URL') }}/images/emails/icons/gradient-link.png'); margin: 0 0 40px;">@lang('emails.fewComments.createFeedback')</a>
                                </td>
                            </tr>
                            <tr>
