...
@section('content')
    <div class="main__info">
        <div class="reg-page">
            <h1 class="reg-page__title">{{ __('auth.readyToConnect') }}</h1>
            ...
            <form method="POST" id="register-form" action="{{ route('register') }}" class="reg-page__form" novalidate>
                ...
                <div class="reg-page__agreement input-text-wrapper">
                    <span class="input-checkbox">
                        ...
                        <label for="tt">Я согласен с <a href="/policy" target="_blank">условиями использования</a> и <a href="/policy" target="_blank">политикой конфиденциальности</a></label>
                    </span>
                </div>
